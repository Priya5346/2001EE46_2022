...
#tile section
st.set_page_config(page_title="Single File Computation",page_icon=":computer:",layout="wide")
...
with st.container():
    ...
    input_file=st.file_uploader("Upload the input file",type=["xlsx"], accept_multiple_files=False)
...
with st.container():
    ...
    if work:
        try:
            ...
            pass
        octant_analysis(input_file,mod)
